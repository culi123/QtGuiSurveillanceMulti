/******************************************************
* Class Name: ThostFtdcUserApiStruct
* Class Functional: 业务数据接口定义
* Author: Ryan Sun
* Date: 2015/08/25
* Description: 自定义价差行情 CSpreadDataField
*****************************************************/
/////////////////////////////////////////////////////////////////////////
///@system 新一代交易所系统
...
//自定义策略交易类型
//组合月份，日期，时间，毫秒，交易类型，开平，IF信号价格，IF成交手数，IH信号价格，IH成交手数，IC信号价格，IC成交手数，组合信号价差，平仓盈亏
//分布比率，样本区间平均价差
struct CTradeLogField
{
    ///组合月份代码
    TThostFtdcInstrumentIDType MonthID;
    ///交易日
    ...
    char op_cl[2];
    ///IF信号价格
    TThostFtdcPriceType IFPrice;
    ///IF成交手数
    TThostFtdcVolumeType IFAmount;
    ///IH信号价格
    TThostFtdcPriceType IHPrice;
    ///IH成交手数
    TThostFtdcVolumeType IHAmount;
    ///IC信号价格
    TThostFtdcPriceType ICPrice;
    ///IC成交手数
    TThostFtdcVolumeType ICAmount;
    ///信号成交价差
    TThostFtdcPriceType SpreadPrice;
    ///平仓盈亏
    TThostFtdcPriceType PnL;
    ///分布比率
    TThostFtdcPriceType spread_rate;
    ///样本区间平均价差
    TThostFtdcPriceType avgSpreadPrice;
	///IF合约代码
	TThostFtdcInstrumentIDType IF_ID;
	///IH合约代码
	TThostFtdcInstrumentIDType IH_ID;
	///IC合约代码
	TThostFtdcInstrumentIDType IC_ID;
	///IF委托价格
	TThostFtdcPriceType IF_OrderPrice;
	///IH委托价格
	TThostFtdcPriceType IH_OrderPrice;
	///IC委托价格
	TThostFtdcPriceType IC_OrderPrice;
};
///自定义价差行情
struct CSpreadDataField
{
	///月份代码
	TThostFtdcInstrumentIDType MonthID;
	///交易所代码
	...
	///左腿组合最新成交金额
	TThostFtdcPriceType LastPriceLeft;
	///右腿组合最新成交金额
	TThostFtdcPriceType LastPriceRight;
	///左右腿最近成交金额差,左腿-右腿
	///价差超过套利区间上限，空左多右，相对升水正向套利；价差低于套利区间下限，多左空右，相对贴水反向套利。
	TThostFtdcPriceType LastSpreadPrice;
    
	///空左多右，相对升水正向套利，价差变低，成交成本价差，价差在高位
	///左腿组合最新申买金额，报单可立即成交
	TThostFtdcPriceType BidPriceLeft;
	///左腿组合最新申买量
	TThostFtdcVolumeType BidVolumeLeft;
	///右腿组合最新申卖金额
	TThostFtdcPriceType AskPriceRight;
	///右腿组合最新申卖量
	TThostFtdcVolumeType AskVolumeRight;
	///左右腿最近成交金额差
	TThostFtdcPriceType SLBRSpreadPrice;

	///多左空右，相对贴水反向套利，价差变高，成交成本价差，价差在低位
	///左腿组合最新申卖金额，报单可立即成交
	TThostFtdcPriceType AskPriceLeft;
	///左腿组合最新申卖量
	TThostFtdcVolumeType AskVolumeLeft;
	///右腿组合最新申买金额
	TThostFtdcPriceType BidPriceRight;
	///右腿组合最新申买量
	TThostFtdcVolumeType BidVolumeRight;
	///左右腿最近成交金额差
	TThostFtdcPriceType BLSRSpreadPrice;
};
