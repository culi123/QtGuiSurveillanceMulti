...
public:
	...
	///请求查询投资者品种/跨品种保证金响应
	virtual void estorProductGroupMargin(CThostFtdcInvestorProductGroupMarginField *pInvestorProductGroupMargin, CThostFtdcRspInfoField *pRspInfo, int nRequestID, bool bIsLast) {};
